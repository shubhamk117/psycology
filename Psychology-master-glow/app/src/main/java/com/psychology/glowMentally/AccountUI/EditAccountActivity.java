...
public class EditAccountActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(StaticVars.current_img=="null" || StaticVars.current_img=="" || StaticVars.current_img==null){

        }else{
            if(StaticVars.current_img.trim()!=""){
                Glide.with(getApplicationContext())
                        .load(StaticVars.current_img)
                        .into(img);
            }
                    ...
                    .addOnSuccessListener(
                            new OnSuccessListener<UploadTask.TaskSnapshot>() {
                                        ...
                                        UploadTask.TaskSnapshot taskSnapshot)
                                {
                                    ...
                                    Toast
                                            .makeText(EditAccountActivity.this,
                                                    "Image Uploaded!!",
                                                    Toast.LENGTH_SHORT)
                                            .show();
...
//                                    Log.i("URLDATA: ",urlData);
            ...
            uploadData(StaticVars.current_img);
        }
    }
